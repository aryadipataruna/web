...
<body>
    ...
    <div class="container">
        <h1 class="page-title">Manajemen Laporan Donasi</h1>

        <!-- Section for Laporan Donasi Barang -->
        <div class="data-section">
            <h2>Laporan Donasi Barang</h2>
            <div class="toolbar">
                <input type="search" id="search-donasi" class="search-bar" placeholder="Cari donasi barang...">
                <div>
                    <button id="add-donasi-btn" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Donasi</button>
                    <button id="print-donasi-btn" class="btn btn-primary"><i class="fas fa-print"></i> Cetak PDF</button>
                </div>
            </div>
